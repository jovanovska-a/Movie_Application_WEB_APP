...
<body>
    ...
    <div id="main" style="width: 600px;">
        <h4 class="section-title" style="background-color: #f8f9fa;">Edit Director</h4>
        <form method="POST" enctype="multipart/form-data" id="editForm">
            ...
            <div class="mb-3" style="width: 200px; height: 260px;">
                <img src="<?php echo $director["DirectorImageUrl"] ?>" id="director-image" alt="Director Image">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="FullName" id="fullName" class="form-control" value="<?php echo $director["FullName"] ?>" required />
            </div>

            <div class="mb-3">
                <label for="biography" class="form-label">Biography</label>
                <input type="text" name="Biography" id="biography" class="form-control" value="<?php echo $director["Biography"] ?>" required />
            </div>

            <div class="mb-3">
                <label for="birthDate" class="form-label">Birth Date</label>
                <input type="date" name="BirthDate" id="birthDate" class="form-control" value="<?php echo $director["BirthDate"] ?>" required />
            </div>

            <div class="mb-3">
                <label for="nationality" class="form-label">Nationality</label>
                <input type="text" name="Nationality" id="nationality" class="form-control" value="<?php echo $director["Nationality"] ?>" required />
            </div>
            ...
            <div class="d-grid">
                ...
                <button type="button" class="btn btn-sm btn-outline-secondary"><a href="../Directors" class="text-decoration-none">Go Back</a></button>
            </div>
        </form>
    </div>
